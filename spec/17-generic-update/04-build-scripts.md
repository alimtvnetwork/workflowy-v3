...
See ``images/build-scripts-flow.mmd`` *(diagram pending — was: `build-scripts-flow.mmd`)*
...
| App Spec | Covers |
|----------|--------|
| `02-powershell-build-deploy.md` *(canonical PowerShell build/deploy doc pending — see spec/10-powershell-integration/)* | PowerShell `run.ps1` architecture, config, logging, ldflags, last-release detection |
| [09-build-deploy.md](../16-generic-cli/11-build-deploy.md) | gitmap `run.ps1` steps, CLI flags, version display |
