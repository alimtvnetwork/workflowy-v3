...
See ``images/rename-first-deploy-flow.mmd`` *(diagram pending — was: `rename-first-deploy-flow.mmd`)*
...
| App Spec | Covers |
|----------|--------|
| `02-powershell-build-deploy.md` *(canonical PowerShell build/deploy doc pending — see spec/10-powershell-integration/)* | Retry-on-lock deploy and PATH sync |
| [03-self-update-mechanism.md](../13-cicd-pipeline-workflows/06-self-update-mechanism.md) | Rename-first during self-update, rollback on failure |
| [09-build-deploy.md](../16-generic-cli/11-build-deploy.md) | gitmap rename-first deploy with retry |
