...
See ``images/deploy-path-resolution-flow.mmd`` *(diagram pending — was: `deploy-path-resolution-flow.mmd`)*
...
| App Spec | Covers |
|----------|--------|
| `02-powershell-build-deploy.md` *(canonical PowerShell build/deploy doc pending — see spec/10-powershell-integration/)* | Deploy target resolution and nested deploy structure |
| [09-build-deploy.md](../16-generic-cli/11-build-deploy.md) | gitmap deploy target on PATH, nested `gitmap/` subfolder |
