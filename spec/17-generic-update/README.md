...
See how all specs connect: ``images/unified-architecture.mmd`` *(diagram pending — was: `unified-architecture.mmd`)*

## Self-Update Flow Diagram

See the Mermaid diagram: ``images/self-update-flow.mmd`` *(diagram pending — was: `self-update-flow.mmd`)*
