...
See ``images/cleanup-flow.mmd`` *(diagram pending — was: `cleanup-flow.mmd`)*
...
| App Spec | Covers |
|----------|--------|
| `02-powershell-build-deploy.md` *(canonical PowerShell build/deploy doc pending — see spec/10-powershell-integration/)* | `.old` artifact lifecycle during deploy |
| [03-self-update-mechanism.md](../13-cicd-pipeline-workflows/06-self-update-mechanism.md) | Post-update cleanup of handoff and `.old` files |
