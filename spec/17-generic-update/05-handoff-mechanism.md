...
*(diagram pending — was: `handoff-mechanism-flow.mmd`; caption: Handoff Mechanism Flow)*
...
| App Spec | Covers |
|----------|--------|
| `02-powershell-build-deploy.md` *(canonical PowerShell build/deploy doc pending — see spec/10-powershell-integration/)* | Self-update orchestration (Windows-safe handoff) |
| [03-self-update-mechanism.md](../13-cicd-pipeline-workflows/06-self-update-mechanism.md) | Two-phase handoff, worker launch, foreground blocking |
