...
- `../03-general/02f-self-update-orchestration.md` *(canonical self-update orchestration doc pending)* — App-level orchestration rules
- [../03-general/03-self-update-mechanism.md](../13-cicd-pipeline-workflows/06-self-update-mechanism.md) — Full self-update architecture
- `../../22-app-issues/03-update-sync-lock-loop.md` *(historical app-issue, archived)* — The real gitmap failure and its resolution
