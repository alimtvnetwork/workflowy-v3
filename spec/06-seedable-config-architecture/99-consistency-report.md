...
| 01 | `01-fundamentals/` | ✅ Present (split — 10 files) |
| 02 | `02-features/00-overview.md` | ✅ Present |
| 02.01 | `02-features/01-rag-chunk-settings.md` | ✅ Present |
| 02.02 | `02-features/02-rag-validation-helpers/` | ✅ Present (subfolder) |
| 02.03 | `02-features/03-rag-validation-tests/` | ✅ Present (subfolder) |
| 02.04 | `02-features/04-rag-test-coverage-matrix.md` | ✅ Present |
| 02.05 | `02-features/05-validation-data-seeding/` | ✅ Present (subfolder) |
