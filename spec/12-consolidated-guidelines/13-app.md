# App Specifications — Redirect Stub
...
This file used to duplicate the canonical App Specifications rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../31-app/00-overview.md](../31-app/00-overview.md)** — single source of truth.
...
- [../31-app/00-overview.md](../31-app/00-overview.md) — canonical source
