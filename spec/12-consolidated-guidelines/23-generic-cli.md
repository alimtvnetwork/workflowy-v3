...
This file used to duplicate the canonical Generic CLI rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../16-generic-cli/00-overview.md](../16-generic-cli/00-overview.md)** — single source of truth.
...
- [../16-generic-cli/00-overview.md](../16-generic-cli/00-overview.md) — canonical source
