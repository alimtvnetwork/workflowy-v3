# CI/CD Pipeline Workflows — Redirect Stub
...
This file used to duplicate the canonical CI/CD Pipeline Workflows rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../13-cicd-pipeline-workflows/00-overview.md](../13-cicd-pipeline-workflows/00-overview.md)** — single source of truth.
...
- [../13-cicd-pipeline-workflows/00-overview.md](../13-cicd-pipeline-workflows/00-overview.md) — canonical source
