# Seedable Config Architecture — Redirect Stub
...
This file used to duplicate the canonical Seedable Config Architecture rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../06-seedable-config-architecture/00-overview.md](../06-seedable-config-architecture/00-overview.md)** — single source of truth.
...
- [../06-seedable-config-architecture/00-overview.md](../06-seedable-config-architecture/00-overview.md) — canonical source
