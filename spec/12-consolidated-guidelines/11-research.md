# Coding Guidelines Research — Redirect Stub
...
This file used to duplicate the canonical Coding Guidelines Research rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:
