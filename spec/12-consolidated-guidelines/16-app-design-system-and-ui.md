# App Design System & UI — Redirect Stub
...
This file used to duplicate the canonical App Design System & UI rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../32-ui-design/00-overview.md](../32-ui-design/00-overview.md)** — single source of truth.
...
- [../32-ui-design/00-overview.md](../32-ui-design/00-overview.md) — canonical source
