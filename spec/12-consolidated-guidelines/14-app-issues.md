...
This file used to duplicate the canonical App Issues rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../02-coding-guidelines/01-cross-language/01-issues-and-fixes-log/00-overview.md](../02-coding-guidelines/01-cross-language/01-issues-and-fixes-log/00-overview.md)** — single source of truth.

> **Note:** App-issues content was merged into the cross-language coding guidelines log during P3 cleanup.
...
- [../02-coding-guidelines/01-cross-language/01-issues-and-fixes-log/00-overview.md](../02-coding-guidelines/01-cross-language/01-issues-and-fixes-log/00-overview.md) — canonical source
