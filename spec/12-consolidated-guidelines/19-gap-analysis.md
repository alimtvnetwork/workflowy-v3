# Consolidated Guidelines — Gap Analysis — Redirect Stub
...
This file used to duplicate the canonical Consolidated Guidelines — Gap Analysis rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../18-spec-issues/00-overview.md](../18-spec-issues/00-overview.md)** — single source of truth.

> **Note:** Historical gap-analysis snapshot. Live audit data lives under spec/18-spec-issues/.
...
- [../18-spec-issues/00-overview.md](../18-spec-issues/00-overview.md) — canonical source
