# Coding Guidelines — Redirect Stub
...
This file used to duplicate the canonical Coding Guidelines rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../02-coding-guidelines/00-overview.md](../02-coding-guidelines/00-overview.md)** — single source of truth.
...
- [../02-coding-guidelines/00-overview.md](../02-coding-guidelines/00-overview.md) — canonical source
