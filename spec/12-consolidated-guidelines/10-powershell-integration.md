# PowerShell Integration — Redirect Stub
...
This file used to duplicate the canonical PowerShell Integration rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../10-powershell-integration/00-overview.md](../10-powershell-integration/00-overview.md)** — single source of truth.
...
- [../10-powershell-integration/00-overview.md](../10-powershell-integration/00-overview.md) — canonical source
