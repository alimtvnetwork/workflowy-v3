# Self-Update & App Update — Redirect Stub
...
This file used to duplicate the canonical Self-Update & App Update rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../14-self-update-app-update/00-overview.md](../14-self-update-app-update/00-overview.md)** — single source of truth.
...
- [../14-self-update-app-update/00-overview.md](../14-self-update-app-update/00-overview.md) — canonical source
