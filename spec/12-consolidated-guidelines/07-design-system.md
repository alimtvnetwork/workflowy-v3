...
This file used to duplicate the canonical Design System rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../07-design-system/00-overview.md](../07-design-system/00-overview.md)** — single source of truth.
...
- [../07-design-system/00-overview.md](../07-design-system/00-overview.md) — canonical source
