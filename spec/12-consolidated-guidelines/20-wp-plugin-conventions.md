# WordPress Plugin Conventions — Redirect Stub
...
This file used to duplicate the canonical WordPress Plugin Conventions rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../15-wp-plugin-how-to/00-overview.md](../15-wp-plugin-how-to/00-overview.md)** — single source of truth.
...
- [../15-wp-plugin-how-to/00-overview.md](../15-wp-plugin-how-to/00-overview.md) — canonical source
