...
This file used to duplicate the canonical App Database rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../04-database-conventions/00-overview.md](../04-database-conventions/00-overview.md)** — single source of truth.

> **Note:** App-database content was merged into the canonical DB conventions during P3 cleanup.
...
- [../04-database-conventions/00-overview.md](../04-database-conventions/00-overview.md) — canonical source
