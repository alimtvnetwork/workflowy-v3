# Error Management — Redirect Stub
...
This file used to duplicate the canonical Error Management rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../03-error-manage/00-overview.md](../03-error-manage/00-overview.md)** — single source of truth.
...
- [../03-error-manage/00-overview.md](../03-error-manage/00-overview.md) — canonical source
