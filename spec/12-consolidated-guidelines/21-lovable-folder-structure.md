# `.lovable/` Folder Structure — Redirect Stub
...
This file used to duplicate the canonical `.lovable/` Folder Structure rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../01-spec-authoring-guide/01-folder-structure.md](../01-spec-authoring-guide/01-folder-structure.md)** — single source of truth.
...
- [../01-spec-authoring-guide/01-folder-structure.md](../01-spec-authoring-guide/01-folder-structure.md) — canonical source
