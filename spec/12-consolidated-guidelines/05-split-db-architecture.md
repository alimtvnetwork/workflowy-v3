# Split Database Architecture — Redirect Stub
...
This file used to duplicate the canonical Split Database Architecture rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../05-split-db-architecture/00-overview.md](../05-split-db-architecture/00-overview.md)** — single source of truth.
...
- [../05-split-db-architecture/00-overview.md](../05-split-db-architecture/00-overview.md) — canonical source
