# Code Block System — Redirect Stub
...
This file used to duplicate the canonical Code Block System rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../09-code-block-system/00-overview.md](../09-code-block-system/00-overview.md)** — single source of truth.
...
- [../09-code-block-system/00-overview.md](../09-code-block-system/00-overview.md) — canonical source
