...
Testable acceptance criteria for the Consolidated Guidelines domain. Each criterion is independently verifiable and traceable to a source spec file.
...
|---|-----------|---------------------|--------|
| 1 | (root files) | AT-CONSOLIDATEDGUIDELINES-01..NN | 📝 To populate |
...
grep -rn "AT-CONSOLIDATEDGUIDELINES-" spec/12-consolidated-guidelines/
