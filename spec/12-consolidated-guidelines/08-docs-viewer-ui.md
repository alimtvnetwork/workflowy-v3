...
This file used to duplicate the canonical Docs Viewer UI rules. To eliminate drift (closes audit issue **AUD-C-01**), all rules now live in **one place only**:

> 📄 **[../08-docs-viewer-ui/00-overview.md](../08-docs-viewer-ui/00-overview.md)** — single source of truth.
...
- [../08-docs-viewer-ui/00-overview.md](../08-docs-viewer-ui/00-overview.md) — canonical source
