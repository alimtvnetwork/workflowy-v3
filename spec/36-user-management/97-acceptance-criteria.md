...
Testable acceptance criteria for the User Management domain. Each criterion is independently verifiable and traceable to a source spec file.
...
|---|-----------|---------------------|--------|
| 1 | (root files) | AT-USERMANAGEMENT-01..NN | 📝 To populate |
...
grep -rn "AT-USERMANAGEMENT-" spec/36-user-management/
