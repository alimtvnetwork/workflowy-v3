...
- [02-apperror-struct/03-convenience-constructors.md](../../02-error-architecture/06-apperror-package/01-apperror-reference/02-apperror-struct/03-convenience-constructors.md) — sections 2.2.2–2.2.5
