...
│   ├── 00-overview.md
│   ├── 01-error-handling-reference/00-overview.md     ← 3-tier error flow
...
│   │   ├── 07-error-modal-reference-legacy.md
│   │   ├── 08-color-themes-legacy.md
...
└── 03-error-code-registry/               (18 files + 3 JSON)
    ├── 00-overview.md
    ├── 01-registry/                       ← Master error code list (split into 6 files)
...
| Understand the error flow | `02-error-architecture/01-error-handling-reference/00-overview.md` |
| Build/modify the error modal | `02-error-architecture/04-error-modal/07-error-modal-reference-legacy.md` |
| Format API responses | `02-error-architecture/05-response-envelope/04-response-envelope-reference.md` |
| Add a new error code | `03-error-code-registry/01-registry/` + `09-templates/01-error-codes-template.md` |
