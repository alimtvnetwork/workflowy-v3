...
- Fixed `CapturedError` in `spec/07-error-modal/07-error-modal-reference-legacy.md` — same correction, added clarifying comment.
...
- **Updated `spec/07-error-modal/07-error-modal-reference-legacy.md`** (v2.0.0) — DelegatedRequestServer UI rendering in Stack/Request/Traversal tabs.
