...
| 4 | `07-error-modal-reference-legacy.md` | Redirect stub | ✅ Present → `03-error-modal-reference/` |
| 5 | `08-color-themes-legacy.md` | Redirect stub | ✅ Present → `04-color-themes/` |
...
|--------|--------|--------|
| `08-color-themes-legacy.md` → `00-overview.md` | ✅ Valid |
| `08-color-themes-legacy.md` → `07-error-modal-reference-legacy.md` | ✅ Valid |
| `08-color-themes-legacy.md` → `../03-notification-colors.md` | ✅ Valid |
...
| `06-suppress-global-error.md` → `07-error-modal-reference-legacy.md` | ✅ Valid |
