...
- [Error Modal Reference](./07-error-modal-reference-legacy.md) — GlobalErrorModal structure and data model
- [suppressGlobalError Pattern](./06-suppress-global-error.md) — Why all history mutations use the flag
- [Error Handling Cross-Stack Spec](../01-error-handling-reference/00-overview.md) — Tier 3 frontend capture pipeline
- [React Components Reference](./02-react-components/00-overview.md) — Component code
