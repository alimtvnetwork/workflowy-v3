...
- [Error Handling Cross-Stack Spec](../../01-error-handling-reference/00-overview.md) — PHP, Go, frontend error chain + DelegatedRequestServer flow
...
- [TypeScript Standards](../../../../02-coding-guidelines/02-typescript/08-typescript-standards-reference/00-overview.md) — Type safety rules
