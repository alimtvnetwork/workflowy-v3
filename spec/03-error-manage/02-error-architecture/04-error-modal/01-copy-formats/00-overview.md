...
| # | File | Title | Lines |
|---|------|-------|-------|
| 1 | [`01-compact-report.md`](./01-compact-report.md) | Compact Report (Markdown) — DEFAULT Copy Format | 229 |
| 2 | [`02-full-report.md`](./02-full-report.md) | Full Report (Markdown) | 193 |
| 3 | [`03-full-report-with-backend-logs.md`](./03-full-report-with-backend-logs.md) | Full Report with Backend Logs | 91 |
| 4 | [`04-error-log-txt.md`](./04-error-log-txt.md) | error.log.txt (Backend Error Log) | 52 |
| 5 | [`05-full-log-txt.md`](./05-full-log-txt.md) | log.txt (Backend Full Log) | 30 |
| 6 | [`06-error-log-with-delegated-info.md`](./06-error-log-with-delegated-info.md) | Backend error.log.txt with Delegated Server Info | 129 |
| 7 | [`07-envelope-error-response.md`](./07-envelope-error-response.md) | Envelope Error Response (JSON) | 68 |
| 8 | [`08-session-diagnostics.md`](./08-session-diagnostics.md) | Session Diagnostics (JSON) | 67 |
| 9 | [`09-generator-code-reference.md`](./09-generator-code-reference.md) | Generator Code Reference | 72 |
...
- [Error Modal Spec](../07-error-modal-reference-legacy.md) — Full modal structure and component hierarchy
- [React Components Reference](../02-react-components/00-overview.md) — Portable React code and component props
...
- [Session Logging Spec](../../07-logging-and-diagnostics/02-session-based-logging/00-overview.md) — Session data model
...
- [`01-compact-report.md`](./01-compact-report.md) — Compact Report
- [`02-full-report.md`](./02-full-report.md) — Full Report
- [`03-full-report-with-backend-logs.md`](./03-full-report-with-backend-logs.md) — Full Report With Backend Logs
- [`04-error-log-txt.md`](./04-error-log-txt.md) — Error Log Txt
- [`05-full-log-txt.md`](./05-full-log-txt.md) — Full Log Txt
- [`06-error-log-with-delegated-info.md`](./06-error-log-with-delegated-info.md) — Error Log With Delegated Info
- [`07-envelope-error-response.md`](./07-envelope-error-response.md) — Envelope Error Response
- [`08-session-diagnostics.md`](./08-session-diagnostics.md) — Session Diagnostics
- [`09-generator-code-reference.md`](./09-generator-code-reference.md) — Generator Code Reference
