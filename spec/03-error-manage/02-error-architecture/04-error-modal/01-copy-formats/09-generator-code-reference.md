...
> Full architectural context: [07-error-modal-reference-legacy.md § 11 – Error Report Generation](../07-error-modal-reference-legacy.md#11-error-report-generation)
...
3. **Implement `CapturedError` interface** — See Section 2 of [07-error-modal-reference-legacy.md](../07-error-modal-reference-legacy.md)
