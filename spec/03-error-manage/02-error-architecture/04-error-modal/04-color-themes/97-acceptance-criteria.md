# Color Themes — Acceptance Criteria
...
Aggregated acceptance criteria for the 4 topic file(s) in this folder. ID range: `AT-COLORTHEMES-NN`.
...
|---|-------------|----------|--------|
| 1 | [`01-design-tokens.md`](./01-design-tokens.md) | AT-COLORTHEMES-01 | 📝 To populate |
| 2 | [`02-backend-tab-colors.md`](./02-backend-tab-colors.md) | AT-COLORTHEMES-02 | 📝 To populate |
| 3 | [`03-frontend-and-ui-colors.md`](./03-frontend-and-ui-colors.md) | AT-COLORTHEMES-03 | 📝 To populate |
...
grep -rn "AT-COLORTHEMES-" spec/03-error-manage/02-error-architecture/04-error-modal/04-color-themes/
