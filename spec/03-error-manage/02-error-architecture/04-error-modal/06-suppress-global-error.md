...
- [Error Handling Cross-Stack Spec](../01-error-handling-reference/00-overview.md) — Tier 3: Frontend Error Handling
- [Error Modal Reference](./07-error-modal-reference-legacy.md) — §13 React Code Examples
