# Cli Examples — Acceptance Criteria
...
Aggregated acceptance criteria for the 6 topic file(s) in this folder. ID range: `AT-CLIEXAMPLES-NN`.
...
|---|-------------|----------|--------|
| 1 | [`01-aibridge-examples.md`](./01-aibridge-examples.md) | AT-CLIEXAMPLES-01 | 📝 To populate |
| 2 | [`02-gsearch-examples.md`](./02-gsearch-examples.md) | AT-CLIEXAMPLES-02 | 📝 To populate |
| 3 | [`03-brun-examples.md`](./03-brun-examples.md) | AT-CLIEXAMPLES-03 | 📝 To populate |
| 4 | [`04-nexusflow-examples.md`](./04-nexusflow-examples.md) | AT-CLIEXAMPLES-04 | 📝 To populate |
| 5 | [`05-reset-api-tables.md`](./05-reset-api-tables.md) | AT-CLIEXAMPLES-05 | 📝 To populate |
...
grep -rn "AT-CLIEXAMPLES-" spec/05-split-db-architecture/02-features/01-cli-examples/
