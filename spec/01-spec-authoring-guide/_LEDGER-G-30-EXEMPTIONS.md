...
> **Migrated:** 2026-04-29 from in-source `REDUNDANCY_ALLOWLIST` Set (16 active rows + 16 well-known closed AT-WF-* rows + 2 frozen dispatch rows). Behaviour is preserved (every row's `pathGlob` is `spec/31-app/01-features/97-acceptance-criteria.md` because that is the runner's consumer scope; future Phase 3 may narrow per-row).
...
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-BOARD- | (b) F20 identity closure; row kept for convention documentation | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-CONCURRENCY- | (b) F20 identity closure; row kept for convention documentation | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-CTXMENU- | (b) F20 identity closure; row kept for convention documentation | 2026-04-29 |
...
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-TRASH- | (b) F20 identity closure; row kept for convention documentation | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-MULTISELECT- | (c) Source-file prefix; canonical AT-APP-17..18 in 12-multi-select | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-INFOMODEL- | (c) Source-file prefix; canonical AT-APP-01..05 in 01-information-model | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-MIRRORS- | (c) Source-file prefix; canonical AT-APP-24 in 09-mirrors | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-DV- | (c) 07b-dashboard-view inline; canonical AT-APP-68..75 | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-SM- | (c) 08b-sharing-mirror-interaction inline; canonical AT-APP-76..80 | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-MPG- | (c) 09b-mirror-peer-group-model inline; canonical AT-APP-58..67 | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-TR- | (c) 11b-trash-reaper inline; canonical AT-APP-81..85 | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-MZ- | (c) 12b-multi-select-zoom inline; canonical AT-APP-86..91 | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-TPL- | (c) 13b-templates-snapshot-semantics inline; canonical AT-APP-92..96 | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-OQ- | (c) 14b-offline-queue inline; canonical AT-APP-97..102 | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/01-features/97-acceptance-criteria.md | AT-SR- | (c) 16-search-ranking inline; canonical AT-APP-103..107 | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/02-workflows/00-overview.md | AT-WF-MIGRATE- | Workflow family; AT-APP-66/67 per 10-migration-execution-flow | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/02-workflows/00-overview.md | AT-WF-CREATE- | Workflow family; AT-APP-58/59/62/66/67 per 09-mirror-create-flow | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/02-workflows/00-overview.md | AT-WF-REAPER- | Workflow family; AT-APP-81..85 per 05-trash-reaper-flow | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/02-workflows/00-overview.md | AT-WF-SEARCH- | Workflow family; AT-APP-103..107 per 06-search-query-flow | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/02-workflows/00-overview.md | AT-WF-REPLAY- | Workflow family; AT-APP-97..102 per 07-sync-replay-flow | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/02-workflows/00-overview.md | AT-WF-DETACH- | Workflow family; AT-APP-60..65 subset per 08-mirror-detach-flow | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/02-workflows/00-overview.md | AT-WF-TEMPLATE- | Workflow family; AT-APP-43..46 per 02-template-application-flow | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/02-workflows/00-overview.md | AT-WF-SHARE- | Workflow family; AT-APP-47..51 per 03-share-invite-flow | 2026-04-29 |
| G-30-AT-CITATION-VALIDITY | spec/31-app/02-workflows/00-overview.md | AT-WF-RESTORE- | Workflow family; AT-APP-52..57 per 04-trash-restore-flow | 2026-04-29 |
...
3. **Path-scoping migration (Phase 3 follow-on):** today every row's `pathGlob` is the runner's consumer scope (`spec/31-app/01-features/97-acceptance-criteria.md` or `spec/31-app/02-workflows/00-overview.md`) which is informational only — the runner currently iterates a single consumer set per registered prefix and does not check the row's `pathGlob` against the citing file. When the runner is updated to pass the citing-file path through `isExempt(gate, entry, filePath)`, narrow each row's `pathGlob` to the smallest accurate set.
