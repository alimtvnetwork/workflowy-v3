...
| App-specific features | `spec/31-app/` |
| Known app bugs/issues | `spec/02-coding-guidelines/22-app-issues/` |
| App-specific database schema | `spec/04-database-conventions/` + `spec/05-split-db-architecture/` |
| App-specific UI and design system | `spec/32-ui-design/` |
