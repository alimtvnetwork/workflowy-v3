...
| `spec/00-adrs/97a-acceptance-criteria-fixtures.md` | policy-definition | §3.4 AT-31-D4 negative fixture demonstrates the forbidden `flipMechanism = "TBD"` PR-rejection case by name — required to make the fixture concretely reviewable. Same category-error carve-out as ADR-0031 sibling row above. | F-SPEC-13-CLOSURE (2026-04-29) | 2026-04-29 |
