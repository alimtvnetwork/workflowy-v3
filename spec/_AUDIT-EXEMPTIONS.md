...
| `spec/13-cicd-pipeline-workflows/scripts-as-spec/README.md` | data-catalog | Scripts-as-spec README enumerates sibling audit files by name (`placeholder-token-parity-audit.md`, etc.); the gate-name token appears once in a directory listing description. | F-AUDIT-25 burndown (task #44b, 2026-04-29) | 2026-04-29 |
| `spec/13-cicd-pipeline-workflows/scripts-as-spec/_TEST-CORPUS/README.md` | data-catalog | Test-corpus README references gate `G-13-PLACEHOLDER-TOKEN-PARITY` by name. The token appears in the gate-id, not as a content gap. | F-AUDIT-25 burndown (task #44b, 2026-04-29) | 2026-04-29 |
| `spec/13-cicd-pipeline-workflows/00-overview.md` | category-error | One mention on line 352 inside the directory-listing table describes file `04-install-script-generation.md` as having a "placeholder strategy" (its functional description); the overview itself is a 350+ line load-bearing fixture index, not a placeholder. | F-AUDIT-25 burndown (task #44b, 2026-04-29) | 2026-04-29 |
| `spec/13-cicd-pipeline-workflows/99-consistency-report.md` | data-catalog | Changelog entry on line 84 records the historical fact "Initial folder creation with overview placeholder" — a dated audit log, not current content. Same data-catalog carve-out as corpus-level `99-consistency-report.md`. | F-AUDIT-25 burndown (task #44b, 2026-04-29) | 2026-04-29 |
