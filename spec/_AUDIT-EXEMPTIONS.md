...
| `spec/00-adrs/0031-warn-only-strict-flip-pattern.md` | policy-definition | Two mentions (lines 61 + 150) catalogue the forbidden vague-criterion tokens (`eventually`, `to-be-determined`, `TBD`, `next pass`, `event-driven`, `someday`) that this ADR's §D3 codifies — the ADR IS the SSOT for the rule that G-38 enforces; counting its definitions as offenders is a category error. | F-SPEC-13-CLOSURE (2026-04-29); F-AUDIT-26-CLOSURE (2026-04-29) | 2026-04-29 |
