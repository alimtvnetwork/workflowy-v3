...
Testable acceptance criteria for the Enforcement Rules domain. Each criterion is independently verifiable and traceable to a source spec file.
...
|---|-----------|---------------------|--------|
| 1 | (root files) | AT-ENFORCEMENTRULES-01..NN | 📝 To populate |
...
grep -rn "AT-ENFORCEMENTRULES-" spec/35-enforcement-rules/
