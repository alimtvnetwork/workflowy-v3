...
> [Phase 7, §7.1](07-reference-implementations/01-bootstrap-file.md) — Full bootstrap

### 2. Autoloader (`includes/Autoloader.php`)

PSR-4 mapping from plugin namespace → `includes/` directory. Must log to `autoloader.log`.

> [Phase 7, §7.2](07-reference-implementations/02-autoloader.md) — Full autoloader
...
> [Phase 7, §7.3](07-reference-implementations/03-plugin-php.md) — Full Plugin.php
...
> [Phase 7, §7.5](07-reference-implementations/05-envelope-builder.md) — EnvelopeBuilder used by ResponseTrait

### 5. FileLogger (`includes/Logging/FileLogger.php`)

Structured file-based logging with rotation, deduplication, and stack traces.

> [Phase 4, §4.3](04-logging-and-error-handling/03-file-logger.md) — FileLogger spec
...
> [Phase 4, §4.1](04-logging-and-error-handling/01-two-tier-logging.md) — Two-tier architecture
...
> [Phase 11, §11.3](11-frontend-and-template-patterns/03-page-templates-orchestrator.md) — Orchestrator pattern
...
| Use regex in route patterns | Plain string endpoints | [Phase 14](14-rest-api-conventions/00-overview.md) |
| Include source maps in production | Dev-only source maps | [Phase 11, §11.8](11-frontend-and-template-patterns/08-source-maps-and-build.md) |
| Store option names as strings | `OptionNameType` enum | [Phase 15](15-settings-architecture/00-overview.md) |
