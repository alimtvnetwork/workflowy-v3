...
| # | File | Title | Lines |
|---|------|-------|-------|
| 1 | [`01-enum-architecture.md`](./01-enum-architecture.md) | Phase 2 — Enums and Coding Style | 253 |
| 2 | [`02-enum-metadata-pattern.md`](./02-enum-metadata-pattern.md) | Enum Metadata Pattern | 227 |
| 3 | [`03-self-update-status-enum.md`](./03-self-update-status-enum.md) | SelfUpdateStatusType — Reference Implementation | 164 |
| 4 | [`04-action-type-enum.md`](./04-action-type-enum.md) | ActionType — Reference Implementation | 236 |
...
- [Phase 10 — Deployment Patterns](../10-deployment-patterns/00-overview.md) — uses `SelfUpdateStatusType`
...
- [`01-enum-architecture.md`](./01-enum-architecture.md) — Enum Architecture
- [`02-enum-metadata-pattern.md`](./02-enum-metadata-pattern.md) — Enum Metadata Pattern
- [`03-self-update-status-enum.md`](./03-self-update-status-enum.md) — Self Update Status Enum
- [`04-action-type-enum.md`](./04-action-type-enum.md) — Action Type Enum
