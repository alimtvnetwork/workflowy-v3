...
Aggregated acceptance criteria for the 5 topic file(s) in this folder. ID range: `AT-ENUMSANDCODINGSTYLE-NN`.
...
|---|-------------|----------|--------|
| 1 | [`01-enum-architecture.md`](./01-enum-architecture.md) | AT-ENUMSANDCODINGSTYLE-01 | 📝 To populate |
| 2 | [`02-enum-metadata-pattern.md`](./02-enum-metadata-pattern.md) | AT-ENUMSANDCODINGSTYLE-02 | 📝 To populate |
| 3 | [`03-self-update-status-enum.md`](./03-self-update-status-enum.md) | AT-ENUMSANDCODINGSTYLE-03 | 📝 To populate |
| 4 | [`04-action-type-enum.md`](./04-action-type-enum.md) | AT-ENUMSANDCODINGSTYLE-04 | 📝 To populate |
...
grep -rn "AT-ENUMSANDCODINGSTYLE-" spec/15-wp-plugin-how-to/02-enums-and-coding-style/
