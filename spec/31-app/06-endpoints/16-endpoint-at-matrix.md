...
| 21 | `EP-SHARES-PUBLIC` | POST | `/shares/{id}/public` | `08-share-dialog.md` | yes | `AT-SHARE-05`, `AT-SHARE-06` |
| 22 | `EP-SHARES-UPDATE` | PATCH | `/shares/{id}` | `08-share-dialog.md` | yes | `AT-SHARE-07`, `AT-ROLES-02` |
| 23 | `EP-SHARES-REVOKE` | DELETE | `/shares/{id}` | `08-share-dialog.md` | no | `AT-SHARE-08`, `AT-ROLES-03` |
| 24 | `EP-BOARD-GET` | GET | `/boards/{id}` | `07-board-view.md` | yes | `AT-BOARD-01`, `AT-BOARD-02` |
| 25 | `EP-BOARD-MOVE` | POST | `/boards/{id}/cards/move` | `07-board-view.md` | yes | `AT-BOARD-03`, `AT-BOARD-04`, `AT-INTERACT-06` |
...
| 28 | `EP-BULK-COMPLETE` | POST | `/bulk/complete` | `12-multi-select.md` | no | `AT-MULTI-05` |
...
| 31 | `EP-TEMPLATES-GET` | GET | `/templates/{id}` | `13-templates.md` | yes | `AT-TEMPLATES-03` |
...
| 34 | `EP-TEMPLATES-DELETE` | DELETE | `/templates/{id}` | `13-templates.md` | no | `AT-TEMPLATES-08` |
...
| 37 | `EP-SYNC-STREAM` | GET | `/sync/stream` (SSE) | `14-concurrency-and-sync.md` | yes | `AT-CONCURRENCY-05`, `AT-SSE-PHP-01`, `AT-SSE-PHP-02`, `AT-SSE-PHP-05`, `AT-SSE-PHP-08` |
| 38 | `EP-ME` | GET | `/me` | `02-personas.md` | yes | `AT-APP-01`, `AT-LAYOUT-02`, `AT-ROLES-04` |
| 39 | `EP-ROLES-LIST` | GET | `/workspaces/{id}/roles` | `15-roles-and-permissions.md` | yes | `AT-ROLES-05`, `AT-ROLES-06` |
...
| 43 | `EP-REAPER-RUNS-LIST` | GET | `/admin/trash/reaper/runs` | `11b-trash-reaper.md` | no | `AT-APP-85` |
| 44 | `EP-SEARCH-QUERY` | GET | `/search` | `15b-search.md` (endpoints) · `mem://features/search-functionality` | yes | `AT-APP-103`, `AT-APP-104`, `AT-APP-105`, `AT-APP-106`, `AT-APP-107` |
...
| 46 | `EP-MIRRORS-GROUP-GET` | GET | `/items/{id}/mirror-group` | `09b-mirror-peer-group.md` | yes | `AT-APP-58`, `AT-APP-60`, `AT-APP-65` |
| 47 | `EP-MIRRORS-DETACH` | POST | `/items/{id}/mirror-detach` | `09b-mirror-peer-group.md` | no | `AT-APP-61`, `AT-APP-63`, `AT-APP-64` |
