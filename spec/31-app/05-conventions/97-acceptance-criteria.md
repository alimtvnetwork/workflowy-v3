...
| 1.1.0 | 2026-04-30 | §7 added — promotes the 2 P13 orphan stubs (`AT-AUTH-01`, `AT-RATE-01`) to first-class criteria with Given/When/Then table, request fixture, failure envelope, response headers, frontend contract, and test pointers. Total criteria: 199 → 201. Closes GAP-AMB-04b. |
