...
|--------|------|-----------|---------------------------|
| `POST` | `/wp-json/workflowy/v1/templates` | `CreateTemplateSnapshot` | IdempotencyKey |
| `POST` | `/wp-json/workflowy/v1/templates/{TemplateId}/apply` | `ApplyTemplate (cross-DB; ADR-0019)` | IdempotencyKey + WAL row (F-AUD42-17) |
| `DELETE` | `/wp-json/workflowy/v1/templates/{TemplateId}` | `DeleteTemplate` | IdempotencyKey |
...
- **Tables touched:** cross-db: root.templates + app.nodes
