...
> **P2 — I/O fixtures companion:** Concrete Given/When/Then + JSON request/response fixtures live in [`97a-acceptance-criteria-fixtures.md`](./97a-acceptance-criteria-fixtures.md) (per format [`spec/01-spec-authoring-guide/19-acceptance-criteria-io-table.md`](../01-spec-authoring-guide/19-acceptance-criteria-io-table.md)). `AT-APP-01..14` landed; `AT-APP-15..107` queued in subsequent `next` calls.
