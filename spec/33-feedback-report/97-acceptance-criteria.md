...
Testable acceptance criteria for the Feedback Report domain. Each criterion is independently verifiable and traceable to a source spec file.
...
|---|-----------|---------------------|--------|
| 1 | (root files) | AT-FEEDBACKREPORT-01..NN | 📝 To populate |
...
grep -rn "AT-FEEDBACKREPORT-" spec/33-feedback-report/
