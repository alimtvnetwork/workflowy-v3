# Self Update App Update — Acceptance Criteria
...
Testable acceptance criteria for the Self Update App Update domain. Each criterion is independently verifiable and traceable to a source spec file.
...
|---|-----------|---------------------|--------|
| 1 | [`09-release-versioning/`](./09-release-versioning/00-overview.md) | AT-SELFUPDATEAPPUPDATE-01..05 | 📝 To populate |
