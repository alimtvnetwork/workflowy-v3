...
- [Release Versioning](./09-release-versioning/00-overview.md) — Version resolution for download URLs
- [CI/CD Shared Conventions](../13-cicd-pipeline-workflows/16-shared-conventions.md) — Checksum conventions in CI
