...
> Language-specific details: [Go Standards](../../03-golang/04-golang-standards-reference/00-overview.md) · [PHP Standards](../../04-php/07-php-standards-reference/00-overview.md) · [TypeScript Standards](../../02-typescript/08-typescript-standards-reference/00-overview.md)
...
> **PHP-specific:** [PHP Enums](../../04-php/01-enums/00-overview.md)  
