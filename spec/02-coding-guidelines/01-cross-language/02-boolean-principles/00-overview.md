...
| # | File | Title | Lines |
|---|------|-------|-------|
| 1 | [`01-naming-prefixes.md`](./01-naming-prefixes.md) | Boolean Principles — P1: is/has prefixes, P2: no negative words | 134 |
| 2 | [`02-guards-and-extraction.md`](./02-guards-and-extraction.md) | Boolean Principles — P3: named guards, P4: extract complex expressions | 205 |
| 3 | [`03-parameters-and-conditions.md`](./03-parameters-and-conditions.md) | Boolean Principles — P5: explicit params, P6: no mixed booleans, P7: no inline statements, P8: no raw system calls | 262 |
| 4 | [`04-quick-reference.md`](./04-quick-reference.md) | Boolean Principles — Quick reference table, common mistakes | 155 |
| 5 | [`05-exemptions-and-api.md`](./05-exemptions-and-api.md) | Boolean Principles — Static factory exemption, Result wrapper API | 139 |
...
- [Go Boolean Standards](../../03-golang/02-boolean-standards/00-overview.md) — Go-specific rules and exemptions (P7, P8)
- [Master Coding Guidelines](../15-master-coding-guidelines/00-overview.md) — Consolidated reference
- [Issues & Fixes Log](../01-issues-and-fixes-log/00-overview.md) — Historical fixes
...
- [`01-naming-prefixes.md`](./01-naming-prefixes.md) — Naming Prefixes
- [`02-guards-and-extraction.md`](./02-guards-and-extraction.md) — Guards And Extraction
- [`03-parameters-and-conditions.md`](./03-parameters-and-conditions.md) — Parameters And Conditions
- [`04-quick-reference.md`](./04-quick-reference.md) — Quick Reference
- [`05-exemptions-and-api.md`](./05-exemptions-and-api.md) — Exemptions And Api
