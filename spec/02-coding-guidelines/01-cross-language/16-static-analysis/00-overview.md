...
| # | File | Title | Lines |
|---|------|-------|-------|
| 1 | [`02-go-golangci-lint.md`](./02-go-golangci-lint.md) | Go — golangci-lint Enforcement Rule Mapping | 237 |
| 2 | [`03-php-phpcs-phpstan.md`](./03-php-phpcs-phpstan.md) | PHP — PHP_CodeSniffer + PHPStan Enforcement Rule Mapping | 214 |
| 3 | [`04-csharp-stylecop.md`](./04-csharp-stylecop.md) | C# — StyleCop Analyzers + Roslyn Enforcement Rule Mapping | 227 |
| 4 | [`05-rust-clippy.md`](./05-rust-clippy.md) | Rust — Clippy Lint Enforcement | 175 |
...
| 09 | [09-ci-pipeline-quality-gate/](./09-ci-pipeline-quality-gate/00-overview.md) | All | CI Pipeline + SonarQube Quality Gate | ✅ Complete |
...
| Blank line before return | [Code Style §R4](../04-code-style/03-blank-lines-and-spacing/01-rule-4-before-return-throw.md) | Formatting |
...
- [CI Pipeline & Quality Gate](./09-ci-pipeline-quality-gate/00-overview.md) — Unified CI pipeline
...
- [`02-go-golangci-lint.md`](./02-go-golangci-lint.md) — Go Golangci Lint
- [`03-php-phpcs-phpstan.md`](./03-php-phpcs-phpstan.md) — Php Phpcs Phpstan
- [`04-csharp-stylecop.md`](./04-csharp-stylecop.md) — Csharp Stylecop
- [`05-rust-clippy.md`](./05-rust-clippy.md) — Rust Clippy
- [`06-vb-dotnet-analyzers.md`](./06-vb-dotnet-analyzers.md) — Vb Dotnet Analyzers
- [`07-nodejs-eslint.md`](./07-nodejs-eslint.md) — Nodejs Eslint
- [`08-python-ruff.md`](./08-python-ruff.md) — Python Ruff
- [`09-ci-pipeline-quality-gate/`](./09-ci-pipeline-quality-gate/00-overview.md) — Ci Pipeline Quality Gate
- [`10-cross-language-rule-matrix.md`](./10-cross-language-rule-matrix.md) — Cross Language Rule Matrix
