...
| Blank line before return | [Code Style §R4](../04-code-style/03-blank-lines-and-spacing/01-rule-4-before-return-throw.md) | `SlevomatCodingStandard.ControlStructures.JumpStatementsSpacing` | `linesCountBeforeFirst: 1` |
