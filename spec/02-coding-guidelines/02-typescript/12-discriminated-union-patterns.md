...
| Reference | Location |
|-----------|----------|
| TypeScript Standards (§8) | [08-typescript-standards-reference/00-overview.md § Discriminated Unions](./08-typescript-standards-reference/00-overview.md) |
| Enum Conventions | [00-overview.md](./00-overview.md) |
| Consolidated Review Guide (Type Safety) | [../consolidated-review-guide/08-type-safety.md](../consolidated-review-guide/08-type-safety.md) |
