...
- [PHP Naming Conventions](./03-naming-conventions/00-overview.md) — Array key casing
- [PHP Forbidden Patterns](./02-forbidden-patterns/00-overview.md) — Banned patterns
