...
| AT-RESPONSEKEYTYPEINVENTORY-11 | Adding a new response key REQUIRES (a) adding the case to the PHP enum, (b) regenerating the Go variant, (c) regenerating the TS constant map, (d) appending to the matching topic file; missing any step fails review. | [`00-overview.md`](./00-overview.md) |
