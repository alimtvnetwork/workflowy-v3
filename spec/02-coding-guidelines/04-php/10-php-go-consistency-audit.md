...
**Reference:** [PHP enums.md](./01-enums/00-overview.md), [Go 02-required-methods.md](../03-golang/01-enum-specification/02-required-methods/00-overview.md)
...
**Reference:** [response-key-type-inventory.md](./09-response-key-type-inventory/00-overview.md)
...
- [PHP Enum Specification](./01-enums/00-overview.md)
- [PHP Naming Conventions](./03-naming-conventions/00-overview.md)
- [Go Enum Specification](../03-golang/01-enum-specification/00-overview.md)
- [Go Required Methods](../03-golang/01-enum-specification/02-required-methods/00-overview.md)
