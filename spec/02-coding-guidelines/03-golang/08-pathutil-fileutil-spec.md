...
> **Cross-refs:** [no-negatives](../01-cross-language/12-no-negatives.md), [golang-standards-reference](./04-golang-standards-reference/00-overview.md), [error-code-registry](../../03-error-manage/03-error-code-registry/01-registry/05-gen-sm-lm-errors.md#gen-700-file-system)
...
All error codes are from the [GEN-700: File System](../../03-error-manage/03-error-code-registry/01-registry/05-gen-sm-lm-errors.md#gen-700-file-system) range:
