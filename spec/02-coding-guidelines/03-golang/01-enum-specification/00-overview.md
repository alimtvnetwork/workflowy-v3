...
| [02-required-methods/00-overview.md](02-required-methods/00-overview.md) | Mandatory methods for all enums |
...
- Error Code Registry <!-- external: spec/03-error-manage/03-error-code-registry/01-registry/ -->
...
- [`01-enum-pattern.md`](./01-enum-pattern.md) — Enum Pattern
- [`02-required-methods/00-overview.md`](./02-required-methods/00-overview.md) — Required Methods
- [`03-folder-structure.md`](./03-folder-structure.md) — Folder Structure
- [`04-validation-checklist.md`](./04-validation-checklist.md) — Validation Checklist
- [`05-info-object-pattern.md`](./05-info-object-pattern.md) — Info Object Pattern
