...
Testable acceptance criteria for the Activity Feed domain. Each criterion is independently verifiable and traceable to a source spec file.
...
|---|-----------|---------------------|--------|
| 1 | (root files) | AT-ACTIVITYFEED-01..NN | 📝 To populate |
...
grep -rn "AT-ACTIVITYFEED-" spec/34-activity-feed/
