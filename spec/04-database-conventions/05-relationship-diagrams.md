...
> See [06-rest-api-format/00-overview.md](./06-rest-api-format/00-overview.md) for the full REST API response format.
...
| REST API format | [./06-rest-api-format/00-overview.md](./06-rest-api-format/00-overview.md) |
