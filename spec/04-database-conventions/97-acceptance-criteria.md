...
Testable acceptance criteria for the Database Conventions domain. Each criterion is independently verifiable and traceable to a source spec file.
...
|---|-----------|---------------------|--------|
| 1 | (root files) | AT-DATABASECONVENTIONS-01..NN | 📝 To populate |
