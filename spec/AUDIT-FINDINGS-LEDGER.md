...
| F-SCOPE-25 | LOW | 2026-04-29 (task #6-batch-22) | Resolved | Pure gate-reuse migration (zero new gates registered): 18 prose-MUSTs in `spec/00-adrs/0012-tailwind-v4-theme-block-token-registry.md` §D1–§D7 bound via same-line `(gate G-…)` citations to **10 existing** registry rows (`G-32-*` × 7 + `G-12-LOGICAL-*` × 3 already declared in §"Gates Touched" L218–237): D1 L51/L56→`G-32-NO-TAILWIND-CONFIG`; D1 L61/L69→`G-32-NO-SECOND-STYLING-SYSTEM`; D2 L73/L75→`G-32-TOKEN-REGISTRY`; D2 L86 + D6 L143→`G-32-DARK-MODE-PARITY`; D3 L93/L110→`G-32-HSL-ONLY-TOKENS`; D4 L117/L130→`G-32-NO-RAW-COLORS`; D5 L135/L137→`G-32-VARIANT-SEMANTIC-ONLY`; D7 L151/L165/L168→`G-12-LOGICAL-MARGINS-PADDING`; D7 L164→`G-12-LOGICAL-INSET`. Source 21 → 3 parser-visible (residuals: §D3 §-header label `MUST be authored as HSL`, L10/L26 §Context-section background prose — out of normative §Decision scope). Wider corpus: 1487 → 1469 (Δ –18 = **new single-batch record**). 16th consecutive zero-parser-drift batch. **Methodology note:** initial multi-line replacements on §D1+§D2 paragraphs failed parser-confident-match (whitespace drift between view and reality); per-line single-MUST replacements succeeded uniformly. Lesson: prefer single-line replacements for prose binding work. | `spec/00-adrs/0012-tailwind-v4-theme-block-token-registry.md`, this row |
