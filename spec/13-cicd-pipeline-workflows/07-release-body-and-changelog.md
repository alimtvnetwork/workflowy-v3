...
- [GitHub Release Standard](./17-github-release-standard.md) — Pre-release detection, asset rules
- [Shared Conventions](./16-shared-conventions.md) — Version resolution
...
- [Release Versioning](../14-self-update-app-update/09-release-versioning/00-overview.md) — How versions are resolved and tags created
