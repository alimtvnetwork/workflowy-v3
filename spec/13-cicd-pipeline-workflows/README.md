...
| Document | Purpose |
|----------|---------|
| [10-ci-pipeline.md](./10-ci-pipeline.md) | Continuous integration: lint, vulnerability scan, parallel tests, cross-compiled builds |
| [11-release-pipeline.md](./11-release-pipeline.md) | Release automation: version resolution, binary packaging, install scripts, GitHub releases |
| [03-vulnerability-scanning.md](./03-vulnerability-scanning.md) | Standalone vulnerability scanning: scheduled and manual |
| [12-installation-flow.md](./12-installation-flow.md) | End-to-end installation: one-liner scripts, terminal output, upgrade, uninstall |
| [13-changelog-integration.md](./13-changelog-integration.md) | Changelog format, CI extraction, release body assembly, terminal display |
| [14-version-and-help.md](./14-version-and-help.md) | Version display, help system, command-level docs, CI version verification |
| [15-environment-variable-setup.md](./15-environment-variable-setup.md) | `env` command: persistent variables, PATH registration, auto-home, drive setup |
...
See the Mermaid diagram: ``images/ci-pipeline-flow.mmd`` *(diagram pending — was: `ci-pipeline-flow.mmd`)*

## Unified Architecture Diagram

See the Mermaid diagram: ``images/unified-architecture.mmd`` *(diagram pending — was: `unified-architecture.mmd`)*
