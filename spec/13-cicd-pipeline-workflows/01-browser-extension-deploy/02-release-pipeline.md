...
See [Shared Conventions — Version Resolution](../16-shared-conventions.md#version-resolution) for the resolution logic.
...
Release notes are assembled from conventional commit history. See [GitHub Release Standard](../17-github-release-standard.md) for the full format.
