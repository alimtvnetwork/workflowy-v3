# Cicd Pipeline Workflows — Acceptance Criteria
...
Testable acceptance criteria for the Cicd Pipeline Workflows domain. Each criterion is independently verifiable and traceable to a source spec file.
...
|---|-----------|---------------------|--------|
| 1 | [`01-browser-extension-deploy/`](./01-browser-extension-deploy/00-overview.md) | AT-CICDPIPELINEWORKFLOWS-01..05 | 📝 To populate |
| 2 | [`02-go-binary-deploy/`](./02-go-binary-deploy/00-overview.md) | AT-CICDPIPELINEWORKFLOWS-06..10 | 📝 To populate |
...
grep -rn "AT-CICDPIPELINEWORKFLOWS-" spec/13-cicd-pipeline-workflows/
