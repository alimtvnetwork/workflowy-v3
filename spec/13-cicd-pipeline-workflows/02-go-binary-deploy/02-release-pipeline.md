...
See [Shared Conventions — Version Resolution](../16-shared-conventions.md#version-resolution).
...
- [Shared Conventions](../16-shared-conventions.md) — Version resolution, checksums, permissions
- [GitHub Release Standard](../17-github-release-standard.md) — Release body assembly, pre-release detection
