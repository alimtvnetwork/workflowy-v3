...
> **Related specs:**
> - [20-terminal-output-design/00-overview.md](20-terminal-output-design/00-overview.md) — full terminal formatting
...
>   ``images/terminal-output-pipeline.mmd`` *(diagram pending — was: `terminal-output-pipeline.mmd`)*
...
> **Full spec:** [20-terminal-output-design/00-overview.md](20-terminal-output-design/00-overview.md) — complete
