# Generic Cli — Acceptance Criteria
...
Testable acceptance criteria for the Generic Cli domain. Each criterion is independently verifiable and traceable to a source spec file.
...
|---|-----------|---------------------|--------|
| 1 | [`20-terminal-output-design/`](./20-terminal-output-design/00-overview.md) | AT-GENERICCLI-01..05 | 📝 To populate |
