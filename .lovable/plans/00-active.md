...
**Action:** Apply the same Purpose/Audience/Output/Out-of-scope/DoD fill-in pattern proven on `15-wp-plugin-how-to`. Re-run audit on the 4; expected jump from current ~25 → ~60+ (D).
