...
// Markdown table cell-splitter lives in `./_lib/md-table.mjs` (extracted
// in task #55 so all gates that parse `_GATE-*`/`_AUDIT-*`/`_LEDGER-*`
// tables share one safe implementation; root cause: task #54).
